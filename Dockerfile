...
# RUN Rscript -e 'remotes::install_version("sf",upgrade="never", version = "1.0-18")'
...
RUN Rscript -e 'remotes::install_github("JustusWeyers/classwiseAcor@dff0cb2b2e837f2fe702548cd567085605fb7c5f")'
