...
It should therefore be possible to install and run the PCApp locally as an R package, see [here](#localexec). On the other hand, it is intended to make the application available online, see [here](#webapp)

## Local execution {#localexec}
